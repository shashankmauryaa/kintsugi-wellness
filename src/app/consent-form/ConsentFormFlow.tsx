...
export default function ConsentFormFlow({ therapists }: { therapists: any[] }) {
  ...
  const validateStep = () => {
    switch (step) {
      ...
      case 3: return formData.therapistId !== "";
      case 4: return formData.fullName && formData.age && formData.phone && formData.emergencyContact.name && formData.emergencyContact.phone && formData.emergencyContact.relation;
      case 5: return formData.ack3;
      case 6: return formData.ack4;
      case 7: return formData.ack5;
      case 8: return formData.ack6;
      case 9: return formData.ack7;
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 3:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 3: Your Details</h2>
      ...
      case 4:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 4: About Counselling</h2>
            <div className="text-[var(--color-gold-800)] space-y-4">
      ...
      case 5:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 5: Confidentiality</h2>
            <div className="text-[var(--color-gold-800)] space-y-4">
      ...
      case 6:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 6: Session Guidelines</h2>
      ...
      case 7:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 7: Additional Support</h2>
            <div className="text-[var(--color-gold-800)] space-y-4">
      ...
      case 8:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 8: Record Keeping</h2>
            <div className="text-[var(--color-gold-800)] space-y-4">
      ...
      case 9:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-heading text-[var(--color-gold-900)]">Section 9: Consent</h2>
